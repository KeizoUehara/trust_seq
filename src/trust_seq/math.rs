...
pub fn calc_binomial_distribution_cummulative(
    ...
    if x < 0 {
        ...
        1.0 - calc_regularized_beta(
            ...
            x as f64 + 1.0,
            number_of_trials as f64 - x as f64,
            1.0e-14,
            i32::MAX as usize,
        )
    }
...
mod tests {
    ...
    #[test]
    fn test_math() {
        let f1 = |_n: i32, _x: f64| 1.0;
        let f2 = |_n: i32, _x: f64| 1.0;
        assert_float_eq!(
            1.6180339887802426,
            calc_continued_func(0.0, 1e-10, 10000, f1, f2)
        );
        assert_float_eq!(0.5723649429247, calc_log_gamma(0.5));
        assert_float_eq!(
            0.755337203316395,
            calc_binomial_distribution_cummulative(20, 0.4, 9)
        );
    }
}
