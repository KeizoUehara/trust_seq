        ...
        for kmer in &mut self.kmers.values() {
            ...
            for (g, group) in groups.iter().enumerate() {
                ...
                if total_group_hits as f32 > predicted {
                    let val = (1.0 -
                               calc_binomial_distribution_cummulative(total_group_count as usize,
